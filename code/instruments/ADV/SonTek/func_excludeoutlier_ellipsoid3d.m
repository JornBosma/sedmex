...
n = max(size(xi));
lambda = 2*sqrt(2*log(n));
% originally, the code read: sqrt(2*log(n)); however, then it will remove too many points as it can't handle asymmetric wave shapes!
% 2* is a guess that seems to work well on my data
% BGR
