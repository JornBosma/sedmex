% process manual bed-level observations L2C8_OSSI
close all
clear
clc
...
%%
% prepare output
fileName = makeFileName(data(1,1),'PHZ','manualHeight_L2C8_OSSI');
save([basePath, 'data', filesep, 'misc', filesep, fileName],'data');

% prepare 
manualHeight_L2C8_OSSI.fileName = fileName;
manualHeight_L2C8_OSSI.timeIN = data(1,1);
manualHeight_L2C8_OSSI.timeOUT = data(end,1);
manualHeight_L2C8_OSSI.dt = dt;
manualHeight_L2C8_OSSI.source = 'measured in the field around low tide';
manualHeight_L2C8_OSSI.error = NaN;
manualHeight_L2C8_OSSI.pos = 2;

save([basePath, 'DB' filesep 'instruments.mat'],'manualHeight_L2C8_OSSI','-append')
