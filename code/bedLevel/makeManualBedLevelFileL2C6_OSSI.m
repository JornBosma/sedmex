% process manual bed-level observations L2C6_OSSI
close all
clear
clc
...
%% October 2021
t = MET2sedmextime([2021 10 2 11 45 0]);
id = data(:,1) == t;
data(id,2) = 0.18;
...
%%
% prepare output
fileName = makeFileName(data(1,1),'PHZ','manualHeight_L2C6_OSSI');
save([basePath, 'data', filesep, 'misc', filesep, fileName],'data');

% prepare 
manualHeight_L2C6_OSSI.fileName = fileName;
manualHeight_L2C6_OSSI.timeIN = data(1,1);
manualHeight_L2C6_OSSI.timeOUT = data(end,1);
manualHeight_L2C6_OSSI.dt = dt;
manualHeight_L2C6_OSSI.source = 'measured in the field around low tide';
manualHeight_L2C6_OSSI.error = NaN;
manualHeight_L2C6_OSSI.pos = 2;

save([basePath, 'DB' filesep 'instruments.mat'],'manualHeight_L2C6_OSSI','-append')
