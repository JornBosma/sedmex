% process manual bed-level observations L2C5_SON1
close all
clear
clc
...
%%
% prepare output
fileName = makeFileName(data(1,1),'PHZ','manualHeight_L2C5_SON1');
save([basePath 'data' filesep 'misc' filesep fileName],'data');

% prepare 
manualHeight_L2C5_SON1.fileName = fileName;
manualHeight_L2C5_SON1.timeIN = data(1,1);
manualHeight_L2C5_SON1.timeOUT = data(end,1);
manualHeight_L2C5_SON1.dt = dt;
manualHeight_L2C5_SON1.source = 'measured in the field around low tide';
manualHeight_L2C5_SON1.error = NaN;
manualHeight_L2C5_SON1.pos = 2;

save([basePath 'DB' filesep 'instruments.mat'],'manualHeight_L2C5_SON1','-append')
