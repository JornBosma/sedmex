...
% where is the data?
rawDataPath = [basePath, 'dataRaw' filesep 'OSSI' filesep 'L5C2 OSSI #04.18.09.00.05' filesep 'raw' filesep];
...
for f = 2:nFiles-10 % based on data check
    ...
    % maak metadata
    L5C2_OSSI.fileName = fileName;
    L5C2_OSSI.timeIN = t(1);
    L5C2_OSSI.timeOUT = t(end);
    L5C2_OSSI.p.pos = 2;
    L5C2_OSSI.p.unit = 'm';
    L5C2_OSSI.error = NaN;
    addStructure2AvailableDataDB(SN,L5C2_OSSI);
