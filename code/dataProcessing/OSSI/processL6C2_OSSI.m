...
% where is the data?
rawDataPath = [basePath, 'dataRaw' filesep 'OSSI' filesep 'L6C2 OSSI #04.18.09.00.06' filesep 'raw' filesep];
...
for f = 2:nFiles-10 % based on data check
    ...
    % maak metadata
    L6C2_OSSI.fileName = fileName;
    L6C2_OSSI.timeIN = t(1);
    L6C2_OSSI.timeOUT = t(end);
    L6C2_OSSI.p.pos = 2;
    L6C2_OSSI.p.unit = 'm';
    L6C2_OSSI.error = NaN;
    addStructure2AvailableDataDB(SN,L6C2_OSSI);
