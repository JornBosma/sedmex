...
% where is the data?
rawDataPath = [basePath, 'dataRaw' filesep 'OSSI' filesep 'L4C3 OSSI #04.18.09.00.04' filesep 'raw' filesep];
...
for f = 2:nFiles-10 % based on data check
    ...
    % maak metadata
    L4C3_OSSI.fileName = fileName;
    L4C3_OSSI.timeIN = t(1);
    L4C3_OSSI.timeOUT = t(end);
    L4C3_OSSI.p.pos = 2;
    L4C3_OSSI.p.unit = 'm';
    L4C3_OSSI.error = NaN;
    addStructure2AvailableDataDB(SN,L4C3_OSSI);
