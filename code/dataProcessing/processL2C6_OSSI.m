...
% where is the data?
rawDataPath = [basePath, 'dataRaw' filesep 'OSSI' filesep 'L2C6 OSSI #04.18.09.00.03' filesep 'raw' filesep];

% this is when the OSSI worked
tIn = DBGetDatabaseEntry('instruments',SN,'timeIN',MET2sedmextime([2021 9 10 0 0 0]));
...
for f = 2:nFiles-10 % based on data check
    ...
    % maak metadata
    L2C6_OSSI.fileName = fileName;
    L2C6_OSSI.timeIN = t(1);
    L2C6_OSSI.timeOUT = t(end);
    L2C6_OSSI.p.pos = 2;
    L2C6_OSSI.p.unit = 'm';
    L2C6_OSSI.error = NaN;
    addStructure2AvailableDataDB(SN,L2C6_OSSI);
