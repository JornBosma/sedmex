...
% where is the data?
rawDataPath = [basePath, 'dataRaw' filesep 'OSSI' filesep 'L1C2 OSSI #04.18.09.00.01' filesep 'raw' filesep];
...
for f = 2:nFiles-10 % based on data check
    ...
    % maak metadata
    L1C2_OSSI.fileName = fileName;
    L1C2_OSSI.timeIN = t(1);
    L1C2_OSSI.timeOUT = t(end);
    L1C2_OSSI.p.pos = 2;
    L1C2_OSSI.p.unit = 'm';
    L1C2_OSSI.error = NaN;
    addStructure2AvailableDataDB(SN,L1C2_OSSI);
