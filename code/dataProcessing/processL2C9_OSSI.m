...
% where is the data?
rawDataPath = [basePath, 'dataRaw' filesep 'OSSI' filesep 'L2C9 OSSI #04.18.09.00.08' filesep 'raw' filesep];
...
for f = 2:nFiles-10 % based on data check
    ...
    % maak metadata
    L2C9_OSSI.fileName = fileName;
    L2C9_OSSI.timeIN = t(1);
    L2C9_OSSI.timeOUT = t(end);
    L2C9_OSSI.p.pos = 2;
    L2C9_OSSI.p.unit = 'm';
    L2C9_OSSI.error = NaN;
    addStructure2AvailableDataDB(SN,L2C9_OSSI);
