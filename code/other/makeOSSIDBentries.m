...
L1C2_OSSI(1).sensorHeight = 0.23; % mean z of sensor wrt bed
L1C2_OSSI(1).x = 117445.4; % averaged over measurement period
L1C2_OSSI(1).y = 560044.7; % averaged over measurement period
L1C2_OSSI(1).z = -1.46 + L1C2_OSSI(1).sensorHeight; % mean z of sensor wrt NAP
...
L2C5_OSSI(1).z = -0.61 + L2C5_OSSI(1).sensorHeight;
...
L2C6_OSSI(1).z = -1.17 + L2C6_OSSI(1).sensorHeight;
...
L2C8_OSSI(1).z = -1.33 + L2C8_OSSI(1).sensorHeight;
...
L2C9_OSSI(1).z = -1.46 + L2C9_OSSI(1).sensorHeight;
...
L4C3_OSSI(1).z = -1.43 + L4C3_OSSI(1).sensorHeight;
...
L5C2_OSSI(1).z = -1.45 + L5C2_OSSI(1).sensorHeight;
...
L6C2_OSSI(1).z = -1.45 + L6C2_OSSI(1).sensorHeight;
